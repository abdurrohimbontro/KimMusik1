# Copyright (C) 2021 By Kim official
...
def song(_, message):
    ...
    try:
        ...
        m.edit("❌ Lagu tidak ditemukan\n\nMohon berikan saya Nama lagu yang jelas")
        print(str(e))
        return
    m.edit("📥 Mendownload...")
    try:
        ...
        m.edit("❌ error, tunggu perangkat di perbaiki")
        print(e)
...
async def lyrics(_, message):
    try:
        if len(message.command) < 2:
            await message.reply_text("» **berikan nama lirik juga**")
            return
